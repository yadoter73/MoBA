...
public class Door : MonoBehaviour, IInteractable
{
    ...
    public void Interact(int id)
	{
		...
		else 
		{
			...
			Tween.Rotation(this.transform, startValue: transform.rotation.eulerAngles, endValue: targetRotation, duration: 1f, ease: Ease.InOutBack).OnComplete(() => _isOpen = false);
		}
	}
}
